...
public class RadarFragment extends Fragment implements MainActivityListener{
    ...
    private static class GpsSkyView extends View implements MainActivityListener {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            minScreenDimen = (RadarFragment.mWidth < RadarFragment.mHeight)
                    ? RadarFragment.mWidth : RadarFragment.mHeight;
