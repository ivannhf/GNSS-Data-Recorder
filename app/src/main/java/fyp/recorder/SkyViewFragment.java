...
public class SkyViewFragment extends Fragment implements MainActivityListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        //myView = inflater.inflate(R.layout.radar_layout, container, true);
        //return myView;
        ...
        //ViewGroup placeholder = (ViewGroup) myView.findViewById(R.id.skyView);
        //placeholder.addView(mSkyView);

        //mSkyView = (GpsSkyView) myView.findViewById(R.id.view);
    ...
    public static class GpsSkyView extends View implements MainActivityListener {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            minScreenDimen = (SkyViewFragment.mWidth < SkyViewFragment.mHeight)
                    ? SkyViewFragment.mWidth : SkyViewFragment.mHeight;
