 ...
 * Original file: C:\\Users\\Ludwig\\Documents\\data\\dev\\eclipse\\YGPSSats\\src\\android\\location\\ILocationManager.aidl
 */
...
static final int TRANSACTION_removeUpdates = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_addGpsStatusListener = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_removeGpsStatusListener = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_sendExtraCommand = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_addProximityAlert = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_removeProximityAlert = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getProviderInfo = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_isProviderEnabled = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getLastKnownLocation = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getFromLocation = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getFromLocationName = (IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_addTestProvider = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_removeTestProvider = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_setTestProviderLocation = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_clearTestProviderLocation = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setTestProviderEnabled = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_clearTestProviderEnabled = (IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_setTestProviderStatus = (IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_clearTestProviderStatus = (IBinder.FIRST_CALL_TRANSACTION + 22);
}
public java.util.List getAllProviders() throws android.os.RemoteException;
public java.util.List getProviders(boolean enabledOnly) throws android.os.RemoteException;
public void updateProviders() throws android.os.RemoteException;
